...
public class ReviewController {
	...
	public ResponseEntity<List<ReviewDisplayDTO>> getProductsReviewHandler(@PathVariable Long productId){
		List<ReviewDisplayDTO>reviews= reviewService.getAllReview(productId);
		return new ResponseEntity<List<ReviewDisplayDTO>>(reviews,HttpStatus.OK);
	}
