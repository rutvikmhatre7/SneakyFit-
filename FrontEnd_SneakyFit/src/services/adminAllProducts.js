...
export async function saveProduct(title,price,description,imageUrl,quantity,topLavelCategory,secondLavelCategory,thirdLavelCategory,sizes,discountedPrice){
...
export async function UpdateBetaJi(productId,title,description){
